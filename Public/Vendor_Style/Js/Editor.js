            ...
            j.prototype = {
                ...
                _initDom: function() {
                    var e = this,
                        ...
                        l = void 0,
                        d = void 0;
                    null == i ? (a = o("<div></div>"), s = o("<div></div>"), d = n.children(), n.append(a).append(s), a.css("background-color", "#F3F5F6").css("border", "1px solid #ccc").css('border-radius','4px'), s.css("border", "1px solid #ccc").css("border-top", "none").css("height", "300px").css('border-radius','4px')) : (a = n, s = o(i), d = s.children()),
                        l = o("<div></div>"),
